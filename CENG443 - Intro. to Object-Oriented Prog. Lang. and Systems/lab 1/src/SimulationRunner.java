...
public class SimulationRunner {
    ...
    private static int numberOfStepAllEntitiesCalls = 0;
    ...
    private static void stepAllEntities() {
        ...
        // stores in here.
        numberOfStepAllEntitiesCalls++;
        if (numberOfStepAllEntitiesCalls == Common.getStockReplenishmentFrequency()) {
            numberOfStepAllEntitiesCalls = 0;
            Common.stepAllStores();
        }
        Common.stepAllCustomers();
        ////
    }
