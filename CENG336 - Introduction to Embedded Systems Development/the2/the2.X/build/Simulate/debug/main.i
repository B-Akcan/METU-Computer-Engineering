...
void poll_a() {
    PORTA_current[KEY_RIGHT] = ((LATA) & (1 << (KEY_RIGHT)));
    PORTA_current[KEY_UP] = ((LATA) & (1 << (KEY_UP)));
    PORTA_current[KEY_DOWN] = ((LATA) & (1 << (KEY_DOWN)));
    PORTA_current[KEY_LEFT] = ((LATA) & (1 << (KEY_LEFT)));
